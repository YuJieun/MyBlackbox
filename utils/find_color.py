...
class ColorNames:
    ...
    WebColorMap["Blue1"] = "#0f437d"
    WebColorMap["Blue2"] = "#213ab1"
    WebColorMap["Blue3"] = "#2457B0"
    # WebColorMap["BlanchedAlmond"] = "#FFEBCD"
    WebColorMap["Blue4"] = "#0000FF"
    ...
    WebColorMap["White2"] = "#F5DEB3"
    WebColorMap["White3"] = "#FFFFFF"
    ...
    @staticmethod
    def findNearestWebColorName(rgb):
        return ColorNames.findNearestColorName(rgb, ColorNames.WebColorMap)

    @staticmethod
    def findNearestColorName(rgb, Map):
        B = rgb[0]
        G = rgb[1]
        R = rgb[2]
        mindiff = None
...
#     return ColorNames.findNea
#     print ColorNames.findNearestWebColorName(color)    print ColorNames.findNearestImageMagickColorName(color)